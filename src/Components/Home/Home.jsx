        ...
        <div className='p-105 relative'>
          ...
          <div className=''>
            ...
            <div className='absolute top-[400px] left-[152px] text-white'>
              <h2 className='text-[44px] leading-[54px] '>
                Mridul Hasan
              </h2>
            ...
            <button className="relative px-10 py-4 bg-white text-black font-bold border-2 border-black rounded-none overflow-hidden group transition-all duration-500 hover:text-white">
